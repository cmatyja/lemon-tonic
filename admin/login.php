    ...
    <body>
        <section class="form">
            ...
            <form action="action/login.php" method="post" id="_form_login">
                <input type="text" name="user_login" placeholder="Nom utilisateur..." required/>
        ...
        <script>
            /* globals _submit_login, _alert */

            _submit_login.addEventListener('click', e => {
                e.preventDefault();
                e.stopImmediatePropagation();
                let data = new FormData();
                data.append('user_login', document.getElementsByName('user_login')[0].value);
